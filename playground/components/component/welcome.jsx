...
* @see https://v0.dev/t/YgVlHk0J1xS
...
export function Welcome() {
  return (<>
    <main
      className="flex flex-col items-center justify-center min-h-screen bg-blue-950">
      <div className="flex flex-col items-center justify-center gap-6">
        <h1
          className="text-4xl font-bold text-transparent bg-clip-text bg-gradient-to-r from-blue-500 to-purple-500 animate-typing relative">
          {`
            ...
            <Dialog>
              ...
              <DialogContent
                ...
                <div className="grid gap-4 py-4">
                  ...
                  <Button
                    className="mt-8 text-white bg-gradient-to-r from-blue-600 to-purple-700 animate-typing shadow-lg shadow-blue-500/50 hover:shadow-blue-500/70 transition-shadow px-6 py-3 rounded-lg font-semibold hover:scale-[1.02] hover:translate-y-[-1px] transition-transform duration-300">
                    Submit
                  </Button>
                </div>
              </DialogContent>
          ...
          <Dialog>
            ...
            <DialogContent
              ...
              <DialogHeader>
                ...
                <DialogDescription>Please select your role to proceed.</DialogDescription>
              </DialogHeader>
              <div className="grid gap-4 py-4">
                <Link
                  className="btn btn-primary px-4 py-2 rounded-md bg-blue-600 hover:bg-blue-700 text-white font-semibold hover:translate-y-[-1px] transition-transform"
                  href="#">
                  I'm a recruiter
                </Link>
                <Link
                  className="btn btn-secondary px-4 py-2 rounded-md bg-purple-600 hover:bg-purple-700 text-white font-semibold hover:translate-y-[-1px] transition-transform"
                  href="#">
                  I want to hire a freelancer
                </Link>
              </div>
    ...
    <footer
      className="absolute bottom-0 left-0 right-0 py-2 text-center text-xs text-gray-500">
